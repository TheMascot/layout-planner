...
ALTER TABLE aircraft_templates
    ADD CONSTRAINT FK_AIRCRAFT_TEMPLATES_ON_ID FOREIGN KEY (id) REFERENCES object_template (id);

ALTER TABLE placed_objects
    ADD CONSTRAINT FK_PLACED_OBJECTS_ON_OBJECT_TEMPLATE FOREIGN KEY (object_template_id) REFERENCES object_template (id);

ALTER TABLE placed_objects
    ADD CONSTRAINT FK_PLACED_OBJECTS_ON_SURFACE FOREIGN KEY (surface_id) REFERENCES surfaces (id);

ALTER TABLE vehicle_templates
    ADD CONSTRAINT FK_VEHICLE_TEMPLATES_ON_ID FOREIGN KEY (id) REFERENCES object_template (id);

ALTER TABLE zone_templates
    ADD CONSTRAINT FK_ZONE_TEMPLATES_ON_ID FOREIGN KEY (id) REFERENCES object_template (id);
